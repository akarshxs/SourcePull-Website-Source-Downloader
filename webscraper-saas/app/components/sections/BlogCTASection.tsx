...
const posts = [
  {
    cat: "Deep Dive",
    title: "Mapping a Target's Full API Surface from JS Bundles",
    excerpt: "How to surface every REST and GraphQL endpoint embedded in minified frontend code automatically.",
    date: "Mar 2025",
    read: "8 min",
  },
  {
    cat: "Technique",
    title: "Recursive Crawling Strategies for Modern SPAs",
    excerpt: "Single-page apps lazy-load routes and assets. Here is how to intercept them all before they slip past.",
    date: "Feb 2025",
    read: "6 min",
  },
  {
    cat: "OSINT",
    title: "What a Website Source Code Reveals About Its Stack",
    excerpt: "Framework fingerprinting, CDN detection, dependency graphs, and version leakage — a field guide.",
    date: "Jan 2025",
    read: "10 min",
  },
];
  ...
  return (
    <section className="relative py-28 px-6 overflow-hidden">
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 70% 50% at 50% 50%, rgba(0,201,167,0.06) 0%, transparent 70%)",
        }}
      />
      <div className="relative max-w-3xl mx-auto text-center" ref={ref}>
        ...
        >
          ...
          <h2 className="font-display font-black text-5xl lg:text-6xl text-white mb-5 leading-tight">
            Paste a URL.<br />
            <span className="gt">Get the source.</span>
          </h2>
